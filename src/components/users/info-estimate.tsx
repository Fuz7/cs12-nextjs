...
interface InfoEstimateProps {
  ...
  setIsRejectEstimateOpen: Setter<Estimate | false>;
      ...
      >
        ...
        <DialogFooter className="flex justify-end gap-4">
          ...
          <Button
            ...
            onClick={() => onButtonsClick(setIsRejectEstimateOpen, estimate)}
          >
            Reject Estimate
          </Button>
          ...
          <Button
            ...
            disabled={estimate.status !== "sent"}
            onClick={() => onButtonsClick(setIsApproveEstimateOpen, estimate)}
          >
            Approve Estimate
          </Button>
        </DialogFooter>
